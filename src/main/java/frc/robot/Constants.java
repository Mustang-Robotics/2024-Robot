...
public final class Constants {
  ...
  public static final class OIConstants {
    ...
    public static final double kDriveDeadband = 0.0;
  }

  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond = 2;
    public static final double kMaxAccelerationMetersPerSecondSquared = 2;// Base = 3
  ...
  public static class Vision {
        ...
        public static final Transform3d kRobotToCam =
                new Transform3d(new Translation3d(0.33, 0.0, 0.66), new Rotation3d(0, -.35, 0));
    ...
    public static final class ShooterConstants {
        public static final double kSVolts = 1; //Temp Val
        public static final double kVVoltSecondsPerRotation = 0;//Temp Val
        //public static final int kEncoderPortOne = 1;//Temp Val
        //public static final int kEncoderPortTwo = 2;//Temp Val
        //public static final boolean kEncoderReversed = false;//Temp Val
        public static final double kShooterToTolleranceRPS = 75;//Change to 100


        public static final double armRadius = 18;
        public static final double armPivotXOffset = 7.5; //[24 in length, pivot is 4.5 in from center, so 24 / 2 = 12 - 4.5 = 7.5]
        public static final double armPivotZOffset = 12; //Floor to center of arm pivot
    }
    ...
    public static final class FieldPositionConstants {
      ...
      Speaker Offset[
          (Speaker length / 2 --> 41.38 / 2 = 20.69),
          (Speaker width / 2 --> 18.11 / 2 = 9.055), //April Tag is already y centered
